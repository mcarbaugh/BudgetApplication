...
<div class="categorySection">
    <table>
        <thead>
            <tr id="insuranceHeader">
                <td colSpan="6" class="headerCell">Insurance & Tax</td>
            </tr>
            <tr class="headerRow">
                <th>&nbsp;</th>
        ...
        <tbody id="insuranceCategoryTableBody">
            <c:forEach items="${insuranceItems}" var="item" varStatus="counter">
                <c:url value="insurance${item.id}" var="rowId"/>
                <tr id="${rowId}">
                    <td>                        
    ...
    <button onclick="openNewInsuranceItemDialog()" class="AddItemButton">Add Item</button>
</div>